    ...
    return (
        <>
            ...
            <div className='relative'>
                <button onClick={() => swiperRef.current?.slidePrev()} className='absolute top-0 bottom-0 -left-10'>
                ...
                <button onClick={() => swiperRef.current?.slideNext()} className='absolute top-0 bottom-0 -right-10'>
